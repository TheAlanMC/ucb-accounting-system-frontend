...
@Component({
  selector: 'app-chart-of-accounts-editaccount',
  templateUrl: './chart-of-accounts-editaccount.component.html',
  styleUrls: ['./chart-of-accounts-editaccount.component.css']
})
export class ChartOfAccountsEditaccountComponent {
