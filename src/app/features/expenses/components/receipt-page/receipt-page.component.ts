...
export class ReceiptPageComponent {
  ...
  uploadPayment(){
    ...
    //Calling service
    this.expensesService.createPaymentExpense(this.companyId, this.payment).subscribe({
      next: (data) => {
        //console.log(data);
  ...
  getSubaccounts(){
    this.expensesService.getPaymentSubaccounts(this.companyId).subscribe({
      next: (data) => {
        if(data.data != null){
          //Parsing the data
  ...
  getNextReceiptNumber(){
    this.expensesService.getLastPaymentNumber(this.companyId).subscribe({
      next: (data) => {
        if(data.data != null){
